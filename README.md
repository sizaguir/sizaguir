...
- [**Proyecto 2: ProyectoBasedeDatos**](https://github.com/sizaguir/ProyectoBasedeDatos.git)
  ...
  - **Estado**: Completado
  - **Enlace al proyecto**: [Repositorio en GitHub]([link-al-repositorio](https://github.com/sizaguir/ProyectoBasedeDatos.git))
...
- [**Proyecto 3: POO_Proyecto**](https://github.com/Ariel-Vargas/POO_Proyecto.git)
  ...
  - **Tecnologías**: [Java, NetBeans, JavaFXML, SceneBuilder]
  - **Estado**: Completado
  - **Enlace al proyecto**: [Repositorio en GitHub]([link-al-repositorio](https://github.com/Ariel-Vargas/POO_Proyecto.git))
